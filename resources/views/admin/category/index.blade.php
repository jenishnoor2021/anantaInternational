    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                ...
                {!! Form::open([
                'method' => 'POST',
                'action' => 'AdminCategoryController@store',
                'files' => true,
                            ...
                            <td>
                                <div class="form-check form-switch">
                                    <input class="form-check-input toggle-status-switch" type="checkbox"
                                        id="toggleSwitch{{ $cate->id }}" data-id="{{ $cate->id }}"
                                        {{ $cate->is_active ? 'checked' : '' }}>
                                    <label class="form-check-label" for="toggleSwitch{{ $cate->id }}">
                                        {{ $cate->is_active ? 'Show' : 'Hide' }}
                                    </label>
                                </div>
                            </td>
                        </tr>
