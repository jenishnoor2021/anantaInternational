...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                {!! Form::model($image, [
                'method' => 'PATCH',
                'action' => ['AdminCertificatesController@update', $image->id],
                'files' => true,
                'class' => 'form-horizontal',
                'name' => 'editcertificatesForm',
                ]) !!}
                @csrf
    ...
    <div class="d-flex gap-2">
        ...
        <a class="btn btn-light w-md" href="{{ URL::to('/admin/certificates') }}">Back</a>
    </div>
    </form>
</div>
<!-- end card body -->
...
<script>
    $(function() {
        $("form[name='editcertificatesForm']").validate({
            rules: {
                file: {
                    required: true,
                },
