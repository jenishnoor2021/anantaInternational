    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                ...
                {!! Form::open([
                'method' => 'POST',
                'action' => 'AdminCertificatesController@store',
                'files' => true,
                'class' => 'form-horizontal',
                'name' => 'addcertificatesForm',
                ]) !!}
                @csrf
...
<div class="col-md-8">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title mb-4">Certificates List</h4>
            ...
            <table id="datatable" class="table table-bordered dt-responsive nowrap w-100 mt-3">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <a href="{{ route('admin.certificates.edit', $image->id) }}"
                                class="btn btn-outline-primary waves-effect waves-light"><i
                                    class="fa fa-edit"></i></a>
                            <a href="{{ route('admin.certificates.destroy', $image->id) }}"
...
<script>
    $(function() {
        $("form[name='addcertificatesForm']").validate({
            rules: {
                file: {
                    required: true,
                },
...
<script>
    $(document).on('change', '.toggle-status-switch', function() {
        ...
        $.ajax({
            url: "{{ route('admin.gallery.active') }}",
            type: "POST",
            data: {
                _token: "{{ csrf_token() }}",
                id: agentId
